...
locals {
  ...
  env             = "prd"
  subscription_id = "94a46c10-c399-4797-a00b-8b87e19fb793"

  # Resource Group Section
  resource_group_name            = "Invoice-Flow-DB-PRD"
  resource_group_location_master = "eastus2"

  # Instance Section
  postgres_instance_name                         = "invoice-flow-db"
  ...
  tags = {
    "cost-center" = "890420072"
    "env"         = local.env
    "project"     = "invoice-flow"
    "owner"       = "productplatforms-stonetecnologia"
    "github-org"  = "stone payments"
    "github-repo" = "invoice-flow-db"
    "support"     = "fppd"
  }
  ...
  enable_replica_readonly               = false
  resource_group_location_replica       = "centralus"
  ...
  postgresql_app_user = "invoiceflowappuser"

...
locals {
  ...
  env             = "stg"
  subscription_id = "INFRA-NONPROD"

  # Resource Group Section
  resource_group_name            = "dddd_dd-dd-99-aa-stg"
  ...
  enable_replica_readonly               = 
  resource_group_location_replica       = "centralus" == "eastus2" ? "centralus" : "eastus2"
  postgres_instance_sku_name_replica    = "B_Standard_B1ms"

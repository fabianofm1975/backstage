...
locals {
  ...
  resource_group_name            = "dddd_dd-dd-99-aa-prd"
  resource_group_location_master = "centralus"

  # Instance Section
  postgres_instance_name                         = "dddd_dd-dd-99-aa-db"
  postgres_instance_version                      = 15
  postgres_instance_storage_mb                   = 81920
  ...
  enable_log_analytic_workspace_master = 
  enable_log_audit_storage_master      = 
  ...
  enable_replica_readonly               = true
  resource_group_location_replica       = strcontains("centralus", "eastus2") ? "centralus" : "eastus2"
  postgres_instance_sku_name_replica    = "GP_Standard_D8s_v3"
  enable_log_analytic_workspace_replica =  ? true : false
  enable_log_audit_storage_replica      =  ? true : false
  ...
  postgresql_app_user = "dddd_dd-dd-99-aaappuser"

...
locals {
  ...
  # Instance Section
  postgres_instance_name                         = "castform-db"
  ...
  enable_log_analytic_workspace_master = "true"
  enable_log_audit_storage_master      = "true"
  ...
  resource_group_location_replica       = strcontains("eastus2", "eastus2") ? "centralus" : "eastus2" 
  postgres_instance_sku_name_replica    = "GP_Standard_D2s_v3"
  enable_log_analytic_workspace_replica = "true" ? true : false
  enable_log_audit_storage_replica      = "true" ? true : false
  ...
  postgresql_app_user = "castformappuser"
